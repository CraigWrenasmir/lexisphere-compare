...
def compare_words():
    ...
    # Explore both words individually (quotes removed)
...
{{
    "shared_idioms": ["2-3 idioms or phrases that pair these words together, if any exist. If none exist, return an empty array."],
