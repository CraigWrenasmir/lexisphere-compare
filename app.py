...
def compare_words():
    ...
    # Explore both words individually
...
{{
    ...
    "quotes": ["1-2 famous quotes with author"]
}}
...
{{
    "quotes_with_both": ["2-3 literary quotes or famous sayings containing BOTH words, with author"],
    "shared_idioms": ["2-3 idioms or phrases that pair these words together"],
    ...
    try:
        ...
        for prompt in [word1_prompt, word2_prompt, bridge_prompt]:
            response = client.chat.completions.create(
                model="gpt-4o-mini",
                messages=[
                    {"role": "system", "content": "You are a linguistic and literary expert. Always respond with valid JSON only."},
        ...
        return jsonify({"error": "Failed to process the comparison. Please try again."}), 500
